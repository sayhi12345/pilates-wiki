window.PILATES_DATA = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "flow": "準備⋯\n吸氣 雙踵保持上提，雙膝伸展，推開滑墊。\n呼氣 一側膝部保持伸展，並將同側的腳跟落至腳踏桿下方（踝\n關節背屈），同時彎曲另一側膝部（踝關節保持蹠屈）。滑墊\n將輕微復位。\n吸氣\n提踵（踝關節蹠屈），伸展另一側膝部，雙腿恢復伸直。滑\n墊將略微外移。\n重複練習20-60次",
      "images": [
    ...
    },
    {
      ...
      "flow": "弓步，面向腳踏桿。彎曲一側膝部，跪在滑墊上，腳部抵住肩託（與\n彈簧同側），髖部伸展。另一隻腳踩在腳踏桿上，以蹠球部接觸腳\n展並儘可能加大動作幅度\n踏杆，腳部與坐骨成一條直線。骨盆和脊椎儘量保持中立位並正\n對前方，脊椎豎直。雙手放在腳踏桿上，位於腳的兩側。\n準備，吸氣…\n呼氣 用後腳蹬肩託，同時伸展前側膝部，使滑墊推開至最大限\n度，但後腿的髖部保持伸展。\n吸氣 後腿的髖部保持伸展，彎曲前側膝部，控制滑墊復位。\n每側重複練習5次",
      "images": [
    ...
    },
    {
      ...
      "flow": "弓步，面向腳踏桿。一隻腳的蹠球部踩在腳踏桿上，膝部彎曲，\n並使膝部與坐骨成一條直線。另一條腿伸直，並用腳抵住肩託（靠\n近彈簧的肩託）。骨盆正對前方。上身保持豎直，脊椎伸展一定幅\n度。雙臂向兩側伸直，掌心向下。肩胛骨保持穩定。\n吸氣：軀幹、骨盆和後膝保持穩定，伸展前膝推開滑墊。\n呼氣：軀幹、骨盆和後膝保持穩定，彎曲前膝控制滑墊復位",
      "images": [
